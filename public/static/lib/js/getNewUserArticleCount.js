...
$(document).ready(function () {
  let articleCount = document.querySelector('#new-article');
  getNewUserArticleCount(articleCount);
});



function getNewUserArticleCount(temp) {
  let time = temp.getAttribute('data-time');
  let format = temp.getAttribute('data-format');
  $.ajax({
    type: "POST",
    url: '/article/getNewUserArticleCount',
    data: {
      time: time,
      format: format
    },
